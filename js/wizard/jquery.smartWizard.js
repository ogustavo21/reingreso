...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>Siguiente</a>').attr("href","#").addClass("btn btn-success"),
        previous : $('<a>Anterior</a>').attr("href","#").addClass("btn btn-primary"),
        finish  : $('<a>Finalizar</a>').attr("href","#").addClass("btn btn-default")
    };
